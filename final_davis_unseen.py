...
class ImprovedDTA(nn.Module):
    ...
    def forward(self, drug, protein):
        ...
        d3 = torch.relu(self.drug_conv3(d))
        d5 = torch.relu(self.drug_conv5(d))
        d7 = torch.relu(self.drug_conv7(d))
...
# =========================================
def evaluate(df):
    loader = DataLoader(DTADataset(df), batch_size=64)
    y_true, y_pred = [], []
    ...
    return (
        ...
        concordance_index(y_true, y_pred)
    )
